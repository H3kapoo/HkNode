...
int main()
{
    ...
    label->setConfig("assets/fonts/LiberationSerif-Regular.ttf", HkFontLoader::HkTextConfig{
    ...
    label->getEvents().setOnScrollListener([&label, &a](int32_t val)
        {
            label->setConfig("assets/fonts/cmr10.ttf", HkFontLoader::HkTextConfig{
                    HkFontLoader::HkTextRenderMethod::BITMAP,
                    a
                });
    ...
    std::string smallText = "vhe quick brown fox jumps over the lazy dog";
    // std::string smallText = "The ";
